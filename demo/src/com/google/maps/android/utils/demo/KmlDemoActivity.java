...
public class KmlDemoActivity extends BaseDemoActivity {
    ...
    private void retrieveFileFromResource() {
        try {
            KmlLayer kmlLayer = new KmlLayer(mMap, R.raw.test_custom_marker, getApplicationContext());
...
//        container = container.getContainers().iterator().next();
        ...
        KmlPlacemark placemark = container.getContainers().iterator().next().getPlacemarks().iterator().next();
        ...
        builder.include(polygon.getGeometryObject());
